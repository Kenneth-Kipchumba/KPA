    ...
    <section class="sheet">
            ...
            <thead>
                <tr>
                    <th class="border-0 pl-0 party-header" width="48.5%">
                        <strong  class="text_caps">{{ $invoice->name }}</strong>
                    </th>
                </tr>
            </thead>
            <tbody>
            ...
            <tbody>
                <tr>
                    <td class="border-0 pl-0" width="70%">
                        <p>Invoice No. <strong>{{ $invoice->buyer->code }}</strong></p>   
                    </td>
        ...
        <footer class='text-left'>
           <small >
            ...
            Select Pay Bill.<br/>
            Enter Business No. <strong>891625</strong><br/>
            Enter Account No. <strong>YOUR FULL NAMES</strong><br/>
            Enter the Amount. <strong>3000.00</strong><br/>
            Enter your M-Pesa PIN then send.<br/>
           </p>
        </small>
