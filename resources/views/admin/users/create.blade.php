    ...
    <div class="card-body">
            <div class="row">
                ...
                <div class="form-group col-md-3">
                    <label class="required" for="member_no">{{ trans('cruds.user.fields.member_no') }}</label>
                    <input class="form-control {{ $errors->has('member_no') ? 'is-invalid' : '' }}" type="text" name="member_no" id="member_no" value="{{ old('member_no', $new_id_no) }}" required>
                ...
                <div class="form-group col-md-3">
                    ...
                    <input readonly class="form-control date {{ $errors->has('date_registration') ? 'is-invalid' : '' }}" type="text" name="date_registration" id="date_registration" value="{{ old('date_registration') }}">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select class="form-control select2 {{ $errors->has('designation') ? 'is-invalid' : '' }}" name="designation" id="designation">
                            ...
                            @foreach(App\Models\User::DESIGNATION_SELECT as $key => $label)
                                <option value="{{ $key }}" {{ old('designation', '1') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group" id="designation_specify" style="display:none;">
                            ...
                            <input class="form-control {{ $errors->has('designation_other') ? 'is-invalid' : '' }}" type="text" name="designation_other" id="designation_other" value="{{ old('designation_other', '') }}">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-3">
                    ...
                    <input class="form-control {{ $errors->has('board_reg_no') ? 'is-invalid' : '' }}" type="text" name="board_reg_no" id="board_reg_no" value="{{ old('board_reg_no', '') }}">
                ...
                <div class="form-group col-md-3">
                    ...
                    <input class="form-control {{ $errors->has('workstation') ? 'is-invalid' : '' }}" type="text" name="workstation" id="workstation" value="{{ old('workstation', '') }}">
            ...
            <div class="row d-none">
                ...
                <div class="form-group col-md-3">
                    ...
                    <input class="form-control {{ $errors->has('alt_email') ? 'is-invalid' : '' }}" type="email" name="alt_email" id="alt_email" value="{{ old('alt_email') }}">
                ...
                <div class="form-group col-md-3">
                    ...
                    <input class="form-control {{ $errors->has('password') ? 'is-invalid' : '' }}" type="password" name="password" id="password" value="kenyapaeds"required>
                ...
                <div class="form-group col-md-3 mt-4">
                    <div class="form-check {{ $errors->has('approved') ? 'is-invalid' : '' }}">
                        ...
                        <input class="form-check-input" type="checkbox" name="approved" id="approved" value="1" checked >
