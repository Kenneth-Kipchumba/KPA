<div class="card">
    ...
    <div class="card-body list">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-memberIncomes">
                <thead>
                    <tr>
                        <th width="10">
...
@endcan
  ...
  let table = $('.datatable-memberIncomes:not(.ajaxTable)').DataTable({ buttons: dtButtons })
