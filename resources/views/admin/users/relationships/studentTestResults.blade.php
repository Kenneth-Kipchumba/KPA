<div class="card">
    <div class="card-header">
        <div class="row">
            <div class="col-md-6"> {{ trans('cruds.testResult.title_singular') }} {{ trans('global.list') }}</div>
    ...
    <div class="card-body list">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-studentTestResults">
                <thead>
                    <tr>
                        <th width="10">
...
@endcan
  ...
  let table = $('.datatable-studentTestResults:not(.ajaxTable)').DataTable({ buttons: dtButtons })
