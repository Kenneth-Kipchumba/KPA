...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-invoiceIncomes">
                <thead>
                    <tr>
                        <th width="10">
                ...
                <tbody>
                    @foreach($incomes as $key => $income)
                        <tr data-entry-id="{{ $income->id }}">
                            ...
                            <td>
                                {{ App\Models\Income::MODE_SELECT[$income->mode] ?? '' }}
                            </td>
                            <td>
...
@endcan
  ...
  let table = $('.datatable-invoiceIncomes:not(.ajaxTable)').DataTable({ buttons: dtButtons })
