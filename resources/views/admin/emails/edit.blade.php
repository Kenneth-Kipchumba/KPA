    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.emails.update", [$email->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('list') ? 'is-invalid' : '' }}" name="list" id="list" required>
                    ...
                    @foreach(App\Models\Email::LIST_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('list', $email->list) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @if($errors->has('list'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('custom_list') ? 'is-invalid' : '' }}" name="custom_list" id="custom_list">{{ old('custom_list', $email->custom_list) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('message') ? 'is-invalid' : '' }}" name="message" id="message">{!! old('message', $email->message) !!}</textarea>
            ...
            <div class="form-group">
                <label for="image">{{ trans('cruds.email.fields.image') }}</label>
