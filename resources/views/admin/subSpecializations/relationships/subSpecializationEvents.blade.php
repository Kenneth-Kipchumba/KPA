...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-subSpecializationEvents">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.event.fields.sub_specialization') }}
                        </th>
                        <th>
...
@endcan
  ...
  let table = $('.datatable-subSpecializationEvents:not(.ajaxTable)').DataTable({ buttons: dtButtons })
