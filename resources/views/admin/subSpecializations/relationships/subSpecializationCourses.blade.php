...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-subSpecializationCourses">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.course.fields.sub_specialization') }}
                        </th>
                        <th>
                ...
                <tbody>
                    @foreach($courses as $key => $course)
                        <tr data-entry-id="{{ $course->id }}">
                            ...
                            <td>
                                {{ $course->sub_specialization->name ?? '' }}
                            </td>
                            <td>
...
@endcan
  ...
  let table = $('.datatable-subSpecializationCourses:not(.ajaxTable)').DataTable({ buttons: dtButtons })
