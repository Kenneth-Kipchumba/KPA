...
class CoursesController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $query = Course::with(['specialization', 'teacher', 'students'])->select(sprintf('%s.*', (new Course())->table));
            ...
            $table->rawColumns(['actions', 'placeholder', 'thumbnail', 'specialization', 'is_published']);
    ...
    public function create()
    {
        ...
        return view('admin.courses.create', compact('specializations', 'teachers', 'students'));
    }
    ...
    public function edit(Course $course)
    {
        ...
        $course->load('specialization', 'teacher', 'students');

        return view('admin.courses.edit', compact('specializations', 'teachers', 'students', 'course'));
    }
    ...
    public function show(Course $course)
    {
        ...
        $course->load('specialization', 'teacher', 'students', 'courseLessons', 'courseTests');
