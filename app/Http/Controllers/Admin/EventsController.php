...
class EventsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $query = Event::with(['specialization'])->select(sprintf('%s.*', (new Event())->table));
            ...
            $table->editColumn('category', function ($row) {
                return $row->category ? Event::CATEGORY_SELECT[$row->category] : '';
            });
        ...
        $photo->thumbnail
            ...
            $table->rawColumns(['actions', 'placeholder', 'specialization', 'photo']);
    ...
    public function create()
    {
        ...
        return view('admin.events.create', compact('specializations'));
    }
    ...
    public function edit(Event $event)
    {
        ...
        $event->load('specialization');

        return view('admin.events.edit', compact('specializations', 'event'));
    }
    ...
    public function show(Event $event)
    {
        ...
        $event->load('specialization', 'eventEventAttendances');
